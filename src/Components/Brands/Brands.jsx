    ...
    if (findShoes.length < 4) {
      ...
      return (
        <div className="galleryBanner">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4  p-4 md:w-1/2 lg:w-11/12  md:mx-auto" data-aos="flip-left">
            {findShoes.map((shoes) => (
              <div key={shoes._id}>
                <div
                  className="card hover:shadow-xl md:w-80 h-[40rem] bg-[#FFF9ED]  mb-10"
                  
                >
                  <figure>
                    <img className="h-72 w-full" src={shoes.photo} alt="Shoes" />
                  </figure>
                ...
                >
                  ...
                  <div className="card-body text-white">
                    ...
                    <div className="card-actions justify-between">
                      ...
                      <NavLink to={`/details/${shoes._id}`}>
                        <button className="btn border-0 bg-[#3B1E00] text-white font-bold btn-sm">
                          Show More
                        </button>
                      </NavLink>
                    </div>
